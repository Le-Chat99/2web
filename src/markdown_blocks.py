...
def block_to_block_type(block):
    ...
    elif re.match(unorder_pattern,block):
        return block_type_unordered_list
    elif re.match(order_pattern,block):
...
def unorderedlist_to_html_node(block):
    ...
    for item in items:
        ...
        items_list.append(ParentNode("li",children))
    return ParentNode("ul", items_list)
...
def orderedlist_to_html_node(block):
    ...
    for item in items:
        ...
        children = text_to_children(text)
        items_list.append(ParentNode("li",children))
    return ParentNode("ol", items_list)
